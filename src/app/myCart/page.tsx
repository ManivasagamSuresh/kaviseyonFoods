    ...
    <div className="px-7 md:px-28 lg:px-52 xl:px-72 2xl:px-80 py-2 min-h-[calc(100vh-88px)] lg:min-h-[calc(100vh-104px)] xl:min-h-[calc(100vh-120px)]   pageMountAnimation w-full max-w-[1850px]">
      ...
      <div className="flex mt-5 lg:mt-0">
        ...
        <div className="w-full lg:w-5/12 flex flex-col gap-4 items-center lg:items-end">
          <div className="flex items-center mt-3 lg:text-lg 2xl:text-xl"><span className="text-base 2xl:text-lg mr-2">Estimated Total : </span><LiaRupeeSignSolid className="w-[14px] h-[14px] lg:w-4 lg:h-4" /> 123000</div>
          <div className="text-xs">Shipping charges calculated at checkout</div>
          <div className="bg-themeColorDark text-milkWhite px-14 lg:px-24  py-2 text-center rounded-sm font-semibold w-fit 2xl:text-xl">Checkout</div>
        </div>
      </div>
    </div>
    </div>
