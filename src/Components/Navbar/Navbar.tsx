          ...
          <>
            ...
            >
              {MobNav ? (
                ...
                <GiHamburgerMenu className="text-textColor w-5 h-5" />
              )}
            </div>
              ...
              {kaviFoodUser ? (
                !kaviFoodUser.isAdmin ? (
                  ...
                  >
                    ...
                    <div className="absolute top-0 right-0 bg-themeColorDark text-milkWhite rounded-full px-1 py-0.5 text-xs leading-none transform translate-x-1/2 -translate-y-1/2">
                      {kaviFoodUser ? kaviFoodUser.cart.items.length : cart.items.length}
                    </div>
                  </div>
                ) : (
                  <></>
