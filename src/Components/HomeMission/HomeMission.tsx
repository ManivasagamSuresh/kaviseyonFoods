...
function HomeMission() {
  return (
    <div className='h-[720px] lg:h-[480px] my-2 lg:my-20 flex flex-col lg:flex-row w-full '>
        <div className='flex flex-1 justify-center items-center gap-4 lg:gap-10 h-full p-4 lg:p-8 flex-col text-justify'>
            ...
            <div> At Kaviseyon Foods, our mission is to create high-quality, nutritious, and delightful
            ...
            and more enjoyable for families everywhere.</div>
        </div>
        <div  className='flex flex-1 justify-center items-center h-full relative'>
                <div className='relative h-5/6 lg:h-full w-8/12 lg:w-10/12'>
