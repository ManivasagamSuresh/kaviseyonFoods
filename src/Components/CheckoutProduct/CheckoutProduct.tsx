  ...
  return (
    <div className='flex justify-between'>
        ...
        <div className="w-16 h-20 relative border">
            <div className='absolute top-[-12px] right-[-8px] bg-themeColorDark text-milkWhite rounded-full text-xs flex justify-center items-center z-10 h-5 w-5'>{item.quantity}</div>
        ...
        <div className='flex gap-1 items-center h-fit'> <LiaRupeeSignSolid className="w-[14px] h-[14px] lg:w-4 lg:h-4" />{item.price * item.quantity}</div>
    </div>
  );
}
