...
const Categories: React.FC<CategoriesProps> = ({ setCategory }) => {
  ...
  return (
    ...
    >
      <div className="cursor-pointer hover:scale-110 duration-100 flex items-center gap-2 bg-bgLightGreen py-2 px-3 rounded-md font-semibold" onClick={() => handleNavigation("Category/Kids")}>
       <LuBaby/> Kids
      </div>
     <div>|</div>
